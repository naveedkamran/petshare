...
public class RiakExample {
    ...
    private static RiakExample mongoService = null;

    public static final RiakExample getInstance() {
        if (mongoService == null) {
            mongoService = new RiakExample();
        }
    ...
    public static void main(String[] args) {
        try {
            ...
            RiakCluster cluster = RiakUtil.getInstance().setUpCluster();
