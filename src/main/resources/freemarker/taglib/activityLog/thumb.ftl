...
<div style="text-align: right; min-width: 98%; max-width: 98%; border: 1px solid black;">
    <div class="attObjectThumb" style="text-align: center; padding: 5px;">

        <#if attObjectThumb?has_content>
        <img alt="${attObjectThumb.docObject.name}" class="imageIcon100" src="doc_object/${attObjectThumb.docObject.rcode}/download"/>
        <#else>
    ...
    <div class="attObjectThumbHov" style="text-align: center;" onclick="createAttObject();">
